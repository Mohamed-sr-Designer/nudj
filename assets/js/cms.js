...
(function (root) {
  ...
  const ARR = ["ANIMALS", "MARINADES", "STYLES", "PRODUCTS", "FAQ", "HOME", "HELP", "ORDER_STEPS"];
  ...
  const CMS = root.NUDJ_CMS = { apply, snapshot, hash, KEYS, active: false, preview: false, rerender: false };
  ...
  if ((ov && hash(ov) !== (meta ? meta.content : "0")) || file === "404.html") {
    CMS.rerender = true;
    document.write('<script src="assets/js/templates.js?v=' + (meta ? meta.getAttribute("data-tpl") : "") + '"><\/script>');
  }
