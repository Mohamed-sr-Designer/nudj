...
window.NUDJ = (function () {
  ...
  const ANIMALS = [
    ...
    { k: "camel", n: "جمل", en: "CAMEL", code: "C", ratio: 958 / 818,
  ...
  /* ---------- جمل ---------- */
  cut("camel-bone", "camel", "جمل بالعظم", "shoulder", 58, ["kabsa", "mandi", "stew"], ["kabsa", "slow"], { bone: true, spec: [2, 2, 4],
    short: "للكبسة والمندي", info: "قطع كبيرة بالعظم تحتاج طبخاً أطول من الضأن بنحو نصف ساعة إلى ساعة." });
  cut("camel-leg", "camel", "فخذ جمل", "leg", 64, ["whole", "cubes", "slices"], ["kabsa", "grill", "oven"], { spec: [3, 1, 4],
    short: "لحم أحمر بلا عظم", info: "ألياف خشنة قليلة الدهن — التتبيل الحمضي والشرائح الرفيعة يطرّيانه للمشاوي." });
  cut("camel-ribs", "camel", "ضلوع جمل", "ribs", 60, ["whole", "stew"], ["slow", "kabsa"], { bone: true, spec: [2, 3, 4],
    short: "ضلوع بطبقة دهن", info: "عظام طويلة ولحم بطبقة دهن — للطبخ الطويل أو الفرن المغطى." });
  cut("camel-hump", "camel", "سنام جمل", "hump", 45, ["whole", "cubes"], ["grill", "mince"], { spec: [3, 5, 3],
    short: "دهن نقي للكباب والطبخ", info: "دهن أبيض كثيف يُضاف للمفروم والكباب أو يُذوّب للطبخ." });
  cut("camel-mince", "camel", "مفروم جمل", null, 56, ["mince", "kebab"], ["mince"], { spec: [2, 2, 4],
    short: "مفروم أحمر قليل الدهن", info: "نكهة مميزة ودهن قليل — امزجه بالسنام لكباب أطرى." });
  cut("camel-liver", "camel", "كبدة جمل", null, 52, ["slices", "cubes"], ["grill"], { spec: [3, 1, 4],
  ...
  const COPY = {
    ticker: ["التقطيع مجاني بأي شكل", "التتبيل والتسييخ حسب الطلب", "المستشار يحسب لك بالجرام", "توصيل مجاني من {freeOver} ر.س", "ضأن · ماعز · جمل · عجل · بقر · جاموس"],
    nav: { shop: "المتجر", herd: "القطيع", carcass: "الذبائح", extras: "عدّة الشواء", advisor: "المستشار", search: "ريش، كبسة، جمل…" },
    ...
    home: {
      ...
      seoDesc: "قل لمستشار نُضْج وش المناسبة — مشاوي، كبسة، ذبيحة، ستيك — ويحسب لك الكمية بالجرام والتقطيع والتتبيلة والفحم. ضأن وماعز وجمل وعجل وبقر وجاموس، والتقطيع مجاني.",
      ...
      how: { kicker: "كيف تشتغل", title: "من «عندي عزومة» إلى فاتورة جاهزة.", cta: "جرّبها على حفلة مشاوي",
        steps: [{ t: "قل المناسبة والعدد", d: "مشاوي لعشرة؟ كبسة جمل لعشرين؟ اختر أو اكتبها بكلامك." }, { t: "جاوب أسئلة الجزّار", d: "قطع ولا شرائح؟ بالعظم؟ تتبيلة؟ تسييخ؟ كل خيار واضح بسعره." }, { t: "عدّل واطلب", d: "غيّر أي وزن بـ − و +، أضف طبق ثاني، واطلب الخطة كلها بضغطة." }] },
    ...
    about: { title: "ملحمة تسألك قبل ما تقطّع.", body: "<p class=\"lead\">أغلب الناس ما يعرفون كم كيلو يحتاجون لعزومة عشرة، ولا أي قطعة تنفع للمندي. نُضْج مبني على هالسؤال: قل لنا المناسبة، ونحسب لك الباقي.</p>\n<h2>وش نقدّم</h2>\n<ul><li><b>القطيع:</b> ضأن، ماعز، جمل، عجل، بقر، جاموس — {cutsCount} قطعية بالكيلو و{carcassCount} ذبائح.</li><li><b>التقطيع مجاني:</b> قطع كبسة، أوصال، شرائح، ستيك، حلقات، مفروم، كباب — بأي شكل تبغاه.</li><li><b>خدمات بالطلب:</b> تتبيل، تسييخ، وتغليف مفرّغ — بسعر واضح بالكيلو.</li><li><b>المستشار:</b> يحسب لك الكميات بالجرام والعدّة والبهارات، وتطلب الخطة كاملة.</li></ul>\n<h2>معلومات المنشأة</h2>\n<ul><li>الاسم التجاري: نُضْج</li><li>المدينة: {city}</li><li>السجل التجاري: {cr}</li><li>الرقم الضريبي: {vatNo}</li></ul>" },
  ...
  /* tone: dark (داكن) أو light (ورق فاتح) — يتبدّلان لكسر الأسود */
  const HOME = [
    { k: "hero", n: "البطل والمستشار", on: true, tone: "dark" }, { k: "marquee", n: "شريط أسماء المواشي", on: true, tone: "dark" }, { k: "herd", n: "القطيع", on: true, tone: "light" },
    { k: "occasions", n: "المناسبات", on: true, tone: "dark" }, { k: "how", n: "كيف تشتغل + فاتورة مثال", on: true, tone: "light" }, { k: "uses", n: "وش بتطبخ؟", on: true, tone: "light" },
    { k: "services", n: "خدمات بالطلب", on: true, tone: "dark" }, { k: "cutband", n: "التقطيع مجاني (السكين)", on: true, tone: "dark" }, { k: "carcass", n: "الذبائح", on: true, tone: "light" }, { k: "faq", n: "أسئلة", on: true, tone: "light" }
  ];
  ...
  const HELP = [
    ...
    { k: "advisor", ic: "chat", t: "المستشار", items: [
      ...
      ["هل المستشار ذكاء اصطناعي؟", "لا — يعتمد على قواعد كميات واضحة، ويفهم الكلام البسيط مثل «كبسة جمل لـ 12». الكميات تقديرية ويمكنك تعديلها قبل الطلب."]] },
